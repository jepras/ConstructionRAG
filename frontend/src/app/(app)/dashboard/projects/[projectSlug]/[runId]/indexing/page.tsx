...
interface DashboardProjectIndexingPageProps {
  params: Promise<{
    projectSlug: string;
    runId: string;
  }>;
...
export default function DashboardProjectIndexingPage({ params }: DashboardProjectIndexingPageProps) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Please sign in to view indexing details.</p>
        </div>
      </div>
    );
  }
