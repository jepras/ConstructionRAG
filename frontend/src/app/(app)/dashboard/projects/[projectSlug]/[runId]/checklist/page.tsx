...
interface DashboardProjectChecklistPageProps {
  params: Promise<{
    projectSlug: string;
    runId: string;
  }>;
...
export default function DashboardProjectChecklistPage({ params }: DashboardProjectChecklistPageProps) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Please sign in to access the Checklist feature.</p>
        </div>
      </div>
    );
  }
