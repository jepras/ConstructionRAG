...
class OverviewGenerator:
    ...
    def __init__(
        self, language: str = "danish", model: str = "google/gemini-2.0-flash-exp", skip_api_key_check: bool = False
    ):
    ...
    def fetch_indexing_run_data(self, index_run_id: str) -> Dict[str, Any]:
        ...
        return {"indexing_run": indexing_run, "documents": documents, "chunks": chunks, "document_ids": document_ids}
    ...
    def call_openrouter_api(self, prompt: str, max_tokens: int = 4000) -> str:
        ...
        headers = {
            ...
            "X-Title": "creating overview for wiki",
        }
...
"""
    ...
    def validate_overview_quality(self, overview: str) -> Dict[str, Any]:
        ...
        validation = {
            "has_project_overview": any(
                header in overview for header in ["## Projektoversigt", "# Projektoversigt", "## Project Overview"]
            ),
            ...
            "is_target_language": any(
                word in overview.lower()
                for word in (
                    ["byggeri", "projekt", "dokument", "oversigt"]
    ...
    def calculate_estimated_cost(
        self, analysis: Dict[str, Any], overview: str, representative_chunks: List[Dict]
    ) -> Dict[str, float]:
