...
if __name__ == "__main__":
    ...
    # Export all elements
    # full_df = export_elements_to_csv(enriched_elements, "all_enhanced_elements.csv")

    # Export filtered samples (5 text types + all tables + all images)
    sample_df = export_filtered_samples(enriched_elements, "sample_analysis.csv")

    print(f"\n📁 CSV Files Created:")
    print(f"   📊 Complete analysis: all_enhanced_elements.csv")
    print(f"   🎯 Filtered samples: sample_analysis.csv")
    ...
    print(f"\n🎉 Enhanced structural awareness complete!")
    print(f"📁 Next: Use 'enriched_elements.pkl' in your chunking notebook")
# ==============================================================================
